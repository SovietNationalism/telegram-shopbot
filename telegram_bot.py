    ...
    async def button_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if d == "prod_oxy":
            caption = (
                ...
                "30 pillole 210€\n"
                "60 pillole 380€\n"
                "Spedizione da Germania 🇩🇪 (7-10gg lav.) - Analgesico a base di ossicodone. L'ossicodone offre un'onda calda di pura euforia, benessere totale e un relax corporeo profondo, "
                "con formulazione a durata prolungata. L'esperienza definitiva per il sollievo ricreativo. Provenienza farmaceutica.\n"
                "Per quantitá minori o maggiori scrivi in privato.\n"
                "⚖️ Dose Consigliata:\n"
                "• Principianti: 20mg\n"
                "• Esperti: 40mg"
            )
