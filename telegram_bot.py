    ...
    async def button_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if d == "prod_oxy":
            caption = (
                ...
                "30 pillole 210€\n"
                "60 pillole 380€\n"
                "Spedizione da Germania 🇩🇪 - Analgesico a base di ossicodone. L'ossicodone offre un'onda calda di pura euforia, benessere totale e un relax corporeo profondo, "
                "con formulazione a durata prolungata. Provenienza farmaceutica.\n"
                "Per quantitá minori o maggiori scrivi in DM. Disponibile anche Oxycontin agli stessi mg per un prezzo maggiorato.\n"
                "⚖️ Dose Consigliata:\n"
                "• Principianti: 20mg\n"
                "• Esperti: 40mg"
            )
        ...
        if d == "prod_code1na":
            caption = (
                "LEAN AMNEAL (Codeina/Prometazina) – Sciroppo 118 ml con etichetta\n"
                "\n"
                ...
                "Ogni bottiglia da 115 ml contiene circa 350 mg di diidrocodeina e 200 mg di prometazina cloridrato di provenienza farmaceutica, gusto lampone e colore viola.\n"
                "\n"
                "Dose consigliata da mischiare con soft drink (meglio quelli meno zuccherati):\n"
                "25 ml – dose media\n"
                "50 ml – dose forte (per utenti esperti)\n"
                "\n"
                "1 - 65€\n"
                "2 - 120€\n"
                "5 - 250€\n"
                "10 - 450€\n"
                "20+ - DM\n"
                "(Per I tagli da 5 o più far sapere con più preavviso possibile)"
            )
            await self._send_product(
                context,
                cid,
